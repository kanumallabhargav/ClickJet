...
public class cj_flights_SS10 extends Base
{
WebDriver driver;
	
	@Test
	public void cj_flights_SS10_positiveAction() throws IOException, SQLException
	{
		...
		homeObjects.clickOnUnaccompaniedMinorCheckbox();
