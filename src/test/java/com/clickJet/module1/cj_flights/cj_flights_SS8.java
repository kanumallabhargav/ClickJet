...
public class cj_flights_SS8 extends Base
{
WebDriver driver;
	
	@Test
	public void cj_flights_SS8_positiveAction() throws IOException, SQLException
	{
		...
		homeObjects.clickOnIndianArmedForcesCheckbox();
