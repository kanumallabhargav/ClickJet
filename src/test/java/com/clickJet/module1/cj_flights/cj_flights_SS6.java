...
public class cj_flights_SS6 extends Base
{
WebDriver driver;
	
	@Test
	public void cj_flights_SS6_positiveAction() throws IOException, SQLException
	{
		...
		homeObjects.clickOnFamilyAndFriendsCheckbox();
