...
public class cj_flights_SS7 extends Base
{
WebDriver driver;
	
	@Test
	public void cj_flights_SS7_positiveAction() throws IOException, SQLException
	{
		...
		homeObjects.clickOnSeniorCitizenCheckbox();
